...
<body>
    <?php
        ...
        $datelog = isset($datelog) ? $datelog : '';
        $documentcode = isset($documentcode) ? $documentcode : '';
        $action = isset($action) ? $action : '';
        $remarks = isset($remarks) ? $remarks : '';
        $employee_id = isset($employee_id) ? $employee_id : '';
        $office_id = isset($office_id) ? $office_id : '';
                                    ...
                                    <div class="card-body">
                                        <form method="POST" action="<?php $_SERVER['PHP_SELF'] ?>">
                                            ...
                                            <div class="col-md-4 pr-1">
                                                <div class="form-group">
                                                    ...
                                                    <input name="datelog" type="date" class="form-control" value="<?php echo $datelog; ?>">
                                                </div>
                                            </div>
                                            <div class="col-md-4 pr-1">
                                                <div class="form-group">
                                        ...
                                        <div class="col-md-4 pl-1">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" name="office_id" value="<?php echo $office_id; ?>">
                                                <option>Select...</option>
                                                <?php
